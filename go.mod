module github.com/gemerio/go-gemer

go 1.12

require (
	github.com/algorand/go-algorand v0.0.0-20190805232236-a0a590675eef
	...
	github.com/gemerio/life v0.0.0-20190806073543-eb004263a671
